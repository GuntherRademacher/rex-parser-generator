...
// REx command line: PrintCpp.cpp.template
  ...
  append(L"job->parser->getErrorMessage(pe).c_str()");
                                                            #line 1885 "PrintCpp.cpp.template"
                                                                if (! parseChars)
                                                                {
                                                            #line 2660 "PrintCpp.cpp"
  append(L").c_str()");
                                                            #line 1888 "PrintCpp.cpp.template"
                                                                }
                                                            #line 2664 "PrintCpp.cpp"
  append(L");\n");
